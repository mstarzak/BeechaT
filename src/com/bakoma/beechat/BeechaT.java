...
public class BeechaT extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mBluetoothAdapter == null) {
            Toast.makeText(this, "Protokół Bluetooth nie jest dostępny na tym urządzeniu.", Toast.LENGTH_LONG).show();
            finish();
            return;
        }
    }
    // onStart method - running on startup of app
    @Override
    public void onStart() {
        super.onStart();
    ...
    // onResume method - running on calling back the app
    @Override
    public synchronized void onResume() {
        ...
        if (mChatService != null) {
            ...
            if (mChatService.getState() == BeechaTService.STATE_NONE) {
    ...
    private void setupChat() {
        ...
        mChatService = new BeechaTService(this, mHandler);
    ...
    // onStop method - running when app stops
    @Override
    public void onStop() {
        super.onStop();
    ...
    private void sendMessage(String message) {
        ...
        if (mChatService.getState() != BeechaTService.STATE_CONNECTED) {
        ...
        public void handleMessage(Message msg) {
            ...
            case MESSAGE_STATE_CHANGE:
                ...
                case BeechaTService.STATE_CONNECTING:
                    ...
                    break;
                case BeechaTService.STATE_LISTEN:
                case BeechaTService.STATE_NONE:
            ...
            case MESSAGE_DEVICE_NAME:
                ...
                Toast.makeText(getApplicationContext(), "Połączono z: "
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        case REQUEST_ENABLE_BT:
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                Log.d(TAG, "Bluetooth nie włączony");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.author:
        	// Call new Activity
        	Intent authorIntent = new Intent(this, Author.class);
